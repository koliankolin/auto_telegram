...
class BaseNewsSource(ABC):
    ...
    def create_mem_from_photo(
        ...
        black_im = Image.new('RGBA', (width, height), color=NewsColorsAndFonts.GRADIENT_COLOR.value)  # i.e. black
        ...
        fnt_path = str(cls.get_images_folder() / NewsColorsAndFonts.FONT_MAIN.value)
        ...
        overlay = Image.new('RGBA', (img.size[0], new_image_height), NewsColorsAndFonts.GRADIENT_COLOR.value)
        ...
        d.text(((img.size[0] - width_source) / 2, txt_height), cls.SOURCE, font=fnt_mir,
               fill=NewsColorsAndFonts.LINE_COLOR.value)
        ...
        for line in wrapped_text:
            ...
            d.text(((img.size[0] - w) / 2, current_h), line, font=title_font,
                   fill=NewsColorsAndFonts.MAIN_COLOR.value)
            current_h += h + padding
        ...
        d.line([top, left], fill=NewsColorsAndFonts.LINE_COLOR.value, width=3)
        d.line([top1, left1], fill=NewsColorsAndFonts.LINE_COLOR.value, width=3)
        d.line([top2, left2], fill=NewsColorsAndFonts.LINE_COLOR.value, width=3)
    ...
    def _wrap_text_and_get_total_height(
            ...
            info_font: ImageFont.FreeTypeFont,
        ...
        info_height = info_font.getbbox(NewsColorsAndFonts.INFO.value)[-1]
